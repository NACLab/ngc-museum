...
K = 1 (number of contrastive divergence -- CD -- negative-phase steps to take)
eta = 0.001 (learning rate of Adam optimizer that applies CD updates to synapses)
train_batch_size = 1000 (number of samples to use w/in a CD-batch update)
